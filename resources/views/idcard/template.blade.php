            ...
            <div class="content" style="overflow: hidden;">
                ...
                <div class="photo-box">
                    @if(isset($application->photo))
                        <img src="{{ \App\Models\Application::fileUrl($application->photo) }}" alt="Candidate Photo">
                    @else
                ...
                <div style="overflow: hidden;">
                    ...
                    <div style="float: right; width: 40%; text-align: center;">
                        <div class="signature-box">
                            @if(isset($application->signature))
                                <img src="{{ \App\Models\Application::fileUrl($application->signature) }}" style="height: 50px; width: auto;" alt="Signature">
                            @else
