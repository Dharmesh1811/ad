    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link {{ Request::is('apply-online') ? 'active' : '' }}" href="{{ url('/apply-online') }}"><i class="fas fa-edit me-1"></i>
                        Apply Online</a></li>
            ...
            <div class="modal-body p-4 p-md-5">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="loginPane" role="tabpanel">
                        <form>
                            <div class="form-floating mb-3 mt-2">
                                <input type="text" class="form-control stylish-input" id="loginName" placeholder="Full Name" required>
                                <label for="loginName">Full Name</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control stylish-input" id="loginMob" placeholder="Mobile Number" required>
                                <label for="loginMob">Mobile Number</label>
                            </div>
                            <div class="form-floating mb-4">
                                <input type="date" class="form-control stylish-input" id="loginDob" required>
                                <label for="loginDob" style="color: #ff6600; font-weight: bold;">Date of Birth</label>
                            </div>
                    ...
                    <div class="tab-pane fade" id="signupPane" role="tabpanel">
                        <form>
                            <div class="form-floating mb-3 mt-2">
                                <input type="text" class="form-control stylish-input" id="regName" placeholder="Full Name" required>
                                <label for="regName">Full Name</label>
                            </div>
                            
                            <div class="form-floating mb-3">
                                <input type="tel" class="form-control stylish-input" id="regMob" placeholder="Mobile Number" required>
                                <label for="regMob">Mobile Number</label>
                            </div>
                            
                            <div class="form-floating mb-4">
                                <input type="date" class="form-control stylish-input" id="regDob" required>
